            ...
            <div class="row no-gutters">
              ...
              <div class="row no-gutters my-auto">
                <div class="col-10 col-lg-9 mx-auto">
                  ...
                  <p class="text-4 text-white line-height-4 mb-5">Sign in to Green Finance. If you have an account with us, you can use the same details to login here.</p>
                </div>
              </div>
          </div>
        </div>
            ...
            <div class="col-11 col-lg-9 col-xl-8 mx-auto">
              ...
              <form  method="POST" action="{{ route('login') }} ">
                ...
                <div class="form-group">
                  ...
                  <input type="email"  name="email" class="form-control  @error('email') is-invalid @enderror" id="emailAddress" required placeholder="Enter Your Email" value="{{ old('email') }}" >
                    @error('email')
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control  @error('password') is-invalid @enderror" id="password" required placeholder="Enter Password"  name="password" required autocomplete="current-password">
                    @error('password')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
