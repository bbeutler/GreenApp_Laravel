...
<div id="main-wrapper"> 
  ...
  <div id="content" class="py-4">
    <div class="container">
      <h2 class="font-weight-400 text-center mt-3">Recipient Bank</h2>
      <p class="text-4 text-center mb-4">Enter Recipient Bank Details.</p>
      <div class="row">
          ...
          <div class="bg-light shadow-sm rounded p-3 p-sm-4 mb-4">
            ...
            <form id="form-send-money" method="post">
              <div class="form-group">
                <label for="inputCountry">Destination Country</label>
              ...
              <div class="form-group">
                <label for="payerName">Destination Bank</label>
                <input type="text" value="" class="form-control" data-bv-field="payerName" id="payerName" required placeholder="Enter Name">
              </div>
              <div class="form-group">
                <label for="accNum">Destination account number</label>
                <input type="number" value="" class="form-control" data-bv-field="accNum" id="accNum" required placeholder="Enter Name">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
               ...
               <p  class="text-muted text-center">All transfers are delivered within one business day.</p>
              </div>
              <!-- <div class="form-group">
              ...
              <button class="btn btn-primary btn-block mt-4">Send</button>
            </form>
