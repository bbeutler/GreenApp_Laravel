          ...
          <div class="hero-content mx-auto w-100 h-100 d-flex flex-column">
            <div class="row  no-gutters">
              <div class="col-10 col-lg-9 mx-auto">
                <div class="logo mt-5 mb-5 mb-md-0"> <a class="d-flex" href="index.html" title="Payyed - HTML Template"><img src="images/dashboard-logo.png" alt="Payyed"></a> </div>
              </div>
            </div>
            <div class="row my-auto">
              <div class="col-10 col-lg-9 mx-auto">
                <h1 class="text-11 text-white mb-4">Register</h1>
                <p class="text-4 text-white line-height-4 mb-5">Create an account with Green Finance. If you have an account with Green Finance, you don't need to create a new account</p>
              </div>
            </div>
          </div>
        </div>
